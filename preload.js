...
function preload()
{
    ...
    mountainsImage.src = "./assets/sprites/mountain.png";
    ...
    return new Promise(function(resolve,reject){
        ...
        let p2 = new Promise(function(resolve,reject){
            cloudsImage.addEventListener("load",function(){
                console.log("Image agya 2");
                resolve();
            });
        })

        let p3 = new Promise(function(resolve,reject){
            mountainsImage.addEventListener("load",function(){
                console.log("Image agya 3");
                resolve();
            });
        })
